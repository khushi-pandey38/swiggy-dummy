<?php 
  ...
  setcookie("img",$img,time()+(60*60*48));
  setcookie("name",$img,time()+(60*60*48));
  setcookie("price",$img,time()+(60*60*48));
  setcookie("qty",$img,time()+(60*60*48));
?>
      ...
      <div class="header-part">
        ...
        <div class="bill-details">
          ...
          <div>
            ...
            <span id="money">Rs. <b id='total-cost'>120</b></span>
          </div>
          <div>
          ...
          <div id="t-tax">
            ...
            <span id="tax">Rs. <b id="tax-tax1">24</b></span>
          </div>
        </div>
        <div id="to-pay">
          <strong>To Pay</strong>
          <strong id="to-pay-money">215</strong>
        </div>
      </div>
    </div>
